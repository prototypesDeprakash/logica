        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if orientation != prev_orientation:
                    if orientation:
                        print(orientation)
                        if prev_finger_status == "Start" and orientation == "Left":
                            pydirectinput.keyDown("a")
                            pydirectinput.keyDown("w")
                            time.sleep(0.3)  # Adjust the duration as needed
                            pydirectinput.keyUp("a")
                            pydirectinput.keyUp("w")
                        elif prev_finger_status == "Stop" and orientation == "Left":
                            pydirectinput.keyDown("a")
                            pydirectinput.keyDown("w")
                            time.sleep(0.3)  # Adjust the duration as needed
                            pydirectinput.keyUp("a")
                        ...
                        elif prev_finger_status == "Start" and orientation == "Right":
                            pydirectinput.keyDown("d")
                            pydirectinput.keyDown("w")
                            time.sleep(0.3)  # Adjust the duration as needed
                            pydirectinput.keyUp("d")
                            pydirectinput.keyUp("w")
                        elif prev_finger_status == "Stop" and orientation == "Right":
                            pydirectinput.keyDown("d")
                            pydirectinput.keyDown("w")
                            time.sleep(0.3)  # Adjust the duration as needed
                            pydirectinput.keyUp("d")
                ...
                if finger_status != prev_finger_status:
                    print(finger_status)
                    if finger_status == "Start" and prev_orientation == "Left":
                        pydirectinput.keyUp("a")
                    elif finger_status == "Start" and prev_orientation == "Right":
                        pydirectinput.keyUp("d")
